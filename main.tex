...
\英文诚信承诺书
\摘要标题
\input{sections/hive_mloptimizer/abstract.tex} % 论文摘要

\目录\clearpage % 目录及换页

\input{sections/hive_mloptimizer/contents.tex}\clearpage
...
%   \clearpage
% \附录
%   \input{sections/examples/appendix.tex}
%   \clearpage

\参考文献
{\centering\bibliographystyle{IEEEtran}  %格式
...
\致谢
  \input{sections/hive_mloptimizer/thanks.tex}
\end{document}
